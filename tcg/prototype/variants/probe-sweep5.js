// Probe (c) ladder step: 5x Pit Fighter.
const CB = globalThis.CB;
const C = CB.cards.byId;
CB.cards.DECKS["probe-sweep5"] = [
  C["pit-rat"], C["pit-rat"],
  C["scrap-pup"], C["scrap-pup"],
  C["chain-dog"], C["chain-dog"],
  C["banner-crier"],
  C["hook-fighter"], C["hook-fighter"],
  C["pit-fighter"], C["pit-fighter"], C["pit-fighter"], C["pit-fighter"], C["pit-fighter"],
  C["arena-champion"],
  C["the-main-event"],
...
CB.simDeckHero["probe-sweep5"] = "vex";
