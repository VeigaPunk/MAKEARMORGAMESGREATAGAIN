...
(function (root) {
  ...
  const POOL = [
    ...
    { id: "brick-keeper",   name: "Brick Keeper",   type: "minion", cost: 2, atk: 1, hp: 4, keywords: ["Guard"], text: "Guard" },
    ...
    { id: "wall-of-teeth",  name: "Wall of Teeth",  type: "minion", cost: 4, atk: 3, hp: 6, keywords: ["Guard"], text: "Guard" },
    ...
    { id: "iron-barker",    name: "Iron Barker",    type: "minion", cost: 5, atk: 5, hp: 5, keywords: ["Guard"], text: "Guard" },
    { id: "void-bookie",    name: "Void Bookie",    type: "minion", cost: 5, atk: 4, hp: 6, keywords: ["Ward"], text: "Ward" },
    { id: "last-bell",      name: "Last Bell",      type: "minion", cost: 6, atk: 6, hp: 7, keywords: ["Guard"], text: "Guard" },
    { id: "bone-colossus",  name: "Bone Colossus",  type: "minion", cost: 7, atk: 7, hp: 8, keywords: ["Guard"], text: "Guard" },
    ...
    // ---- Spells ----
    { id: "the-push",       name: "The Push",       type: "spell", cost: 0, text: "+1 mana this turn.",
      effect: (st, pi) => { st.players[pi].tempMana += 1; } },
