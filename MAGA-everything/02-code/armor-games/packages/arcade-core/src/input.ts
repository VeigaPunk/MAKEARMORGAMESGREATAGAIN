 ...
 * game mode is chosen. Default keymaps are PROVISIONAL — exact originals TBD
 * from ARCADE capture (see app README).
 */
 ...
 * fallback. TBD ARCADE — replace with captured original 2P keymap.
 */
