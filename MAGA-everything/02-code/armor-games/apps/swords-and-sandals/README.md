# Swords and Sandals — internal v1 slice
...
|---|---|
| Damage / hit / crit formulas | Simple stat-weighted roll |
| Rewards | Gold and XP per bout |
| Shop prices and level gates | Three-item smithy/armory inventory |
| Status effects | Guarded for one turn after Special |
| SFX timing and roster | Minimal local implementation |
