...
**r12:** burn **committed `69f9b24`** — `'paused'` GameState + Esc/P (D-26), `gameplayDt` cap (D-16), DM crates (D-25→DD-103), `?stress` ~100 movers (D-08 partial), authored art preload (`public/art/boxhead-logo.svg` + `floor-tile.svg`, decorative-fallback), window-level pointerup. All committed-but-unverified pending verify re-probe (DD-111). Still open: DD-01 stage size, DD-16 palette/retint, DD-17 shotgun pellets, DD-19 wave-3 victory, DD-20 chrome, DD-21 KeyJ/K double-bind, verify D-19 grenade owner exemption (ARCADE ruling).
