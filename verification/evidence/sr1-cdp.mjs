// sr1-cdp.mjs — zero-dependency Chromium CDP driver (Node 24 fetch+WebSocket).
// Verification-only: real Input.dispatchKeyEvent / Input.dispatchMouseEvent events.
// Precedent: verification/evidence/sr1-hardest-run.log (headless chromium + CDP).
